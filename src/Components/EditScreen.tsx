...
import { onChangeName } from "../Redux";
interface Props{
   route:any
    ...
    return(
        <View  style={{marginHorizontal:20,marginVertical:5,}}> 
          <StatusBar translucent backgroundColor="rgba(0,0,0,0)" barStyle="dark-content" />
            ...
            <TextInput 
            value={textInput} 
            style={{borderWidth:1,borderColor:"blue",marginTop:10,borderRadius:5,padding:2}}
            onChangeText={setTextInput}
            />
            <Text style={{marginVertical:5,fontSize:12,marginBottom:15}}> Họ & tên gồm 2 từ trở lên</Text>
            <Button 
                title="Lưu thay đổi"
                onPress={()=>{back()}}
            ></Button>
