...
import { onChangePassword } from "../../Redux";
    ...
    <View style={Styles.container}>
      ...
      <View>
        ...
        <TextInput  
          ...
          style={{fontSize:18}}
        />
          <TouchableOpacity onPress={updateSecureTextEntry} style={{padding: 5 }} >
      ...
      <View style={Styles.btn_Change_View}>
          <TouchableOpacity style={Styles.btn_Change} onPress={()=>dispatch(onChangePassword(data.password,data.newPassword))}>
