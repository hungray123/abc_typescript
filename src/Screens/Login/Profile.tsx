...
import { Dimensions, Image, RefreshControl, SafeAreaView, ScrollView, StyleSheet, Text, TouchableOpacity, View,StatusBar, ImageBackground } from "react-native";
  ...
  return (
    ...
    <View style={Styles.container}>
      ...
      <ImageBackground source={Images.purpleBG} style={Styles.block_top}   >
            ...
            <View style={{justifyContent: 'center',flexDirection: 'row'}}>
              ...
              <Image source={Images.Img_Profile} style={Styles.Image_Profile} />
                ...
                <View style={Styles.View2_Title}>
                        ...
                        <Text style={{color: 'gray',justifyContent: 'flex-start',textShadowColor:'black',textShadowRadius:10}}>Hello</Text>
                        <Text style={{fontWeight:'bold',fontSize:22,color:'lightgray',textShadowColor:'black',textShadowRadius:20}}>{uu}</Text>
                  </View>
                
             <View style={Styles.View_block_edit}>
               
                  <TouchableOpacity onPress={()=>{navigation.navigate("EditProfile",{name:uu})}}>
                  <Text style={Styles.View_Edit}><IconFontAwesome name="pencil" size={20} color="#fff" /></Text>
                  </TouchableOpacity>
        ...
        <View style={{justifyContent: 'center',alignItems: 'flex-end',width:'95%'}}>
            ...
            <View style={Styles.View_Body_block}>
              ...
              <View style={Styles.Item}>
                <TouchableOpacity>
                <View style={Styles.Item_title}>
                <IconMaterialIcons name="support-agent" style={Styles.icon_text} /> 
                ...
                <View style={Styles.Item}>
                  <TouchableOpacity onPress={()=>Logout()}>
                    ...
                    <IconMaterialIcons name="logout" style={Styles.icon_text} color='red'  />
