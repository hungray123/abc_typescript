            ...
            <View style={styles.Body_block}>
               <View style={styles.body_wrap}>
                    <View style={styles.body_top_view}>
                            <Text style={[styles.title_payment,{fontSize:22,fontWeight:'bold',paddingVertical:10}]}>Chi tiết thanh Toán</Text>
                    ...
                    <View style={styles.body_body_view}>
                        ...
                        <View style={styles.body_body_right}>
                            ...
                            <Text style={[styles.body_body_text,{fontWeight:'bold',color:'red'}]}>350.000</Text>
                        </View>
                    </View>

                    <View style={styles.service_view}>
                        <View style={styles.service_view_left}>
                            <Text style={styles.body_body_text}>Cho thuê bóng 25.000đ/lượt</Text>
                        </View>
